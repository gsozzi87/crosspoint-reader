...
function askPrompt(book: string, chapter: number, lang: Lang): string {
  return [
    ...
    "Explica el pasaje con claridad y respeto, apoyándote en lo que dice el texto y en el contexto histórico",
    "y cultural en el que fue escrito.",
    "Si pregunta por un rango de versículos ('del 8 al 12'), responde sobre esos versículos y nómbralos.",
    "Si pregunta qué significa una palabra, explica esa palabra en este contexto (qué quería decir cuando se escribió).",
    "Si pregunta qué dice el capítulo o pide un resumen, resume de qué se trata en pocas líneas.",
    "Si pide que se lo expliques 'en lenguaje de hoy' o 'como si fuera para un niño', reescribe el sentido del",
    "capítulo con palabras actuales y sencillas, sin perder lo que dice.",
    "Si pide que le cuentes la historia, narra lo que pasa en el capítulo como un relato corto: quién, qué, dónde",
    "y por qué importa. Si pide una reseña o 'qué dijo', explica el mensaje central y a quién iba dirigido.",
    "No favorezcas la interpretación de ninguna iglesia ni corriente: limítate a lo que dice el texto y, cuando haya",
    "lecturas distintas, indícalo en una línea sin tomar partido. Si algo no está en el capítulo, indícalo en vez de inventarlo.",
    "La pregunta llega transcrita de voz: puede contener errores de reconocimiento; interprétala con sentido común",
