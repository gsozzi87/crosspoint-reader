...
function askPrompt(book: string, chapter: number, lang: Lang): string {
  return [
    ...
    "Si pregunta qué dice el capítulo o pide un resumen, resumí de qué se trata en pocas líneas.",
    "Si pide que se lo expliques 'en lenguaje de hoy' o 'como si fuera para un niño', reescribí el sentido del",
    "capítulo con palabras actuales y sencillas, sin perder lo que dice.",
    "Si pide que le cuentes la historia, narrá lo que pasa en el capítulo como un relato corto: quién, qué, dónde",
    "y por qué importa. Si pide una reseña o 'qué dijo', explicá el mensaje central y a quién iba dirigido.",
