...
class TaskStatsActivity final : public Activity {
 ...
 private:
  ...
  // El medidor de OK mantenido salió en 1.5.93. Existía para contestar sin
  // cable si el evento de pulsación larga llegaba, porque hasta 1.5.46 no
  // llegaba nunca y nadie lo había vuelto a probar. Ya está contestado y el
  // marcador del lector anda, así que era una sección de diagnóstico ocupando
  // una pantalla que se mira por otra cosa.
