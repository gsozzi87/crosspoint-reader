...
class HubActivity final : public Activity {
 ...
 private:
  enum Tile { TILE_READ = 0, TILE_TALK, TILE_TRANSLATOR, TILE_REMINDERS, TILE_TIMER, TILE_NOTES, TILE_BIBLE, TILE_MUSIC, TILE_NEWS, TILE_PHOTOS, TILE_GAMES, TILE_SETTINGS, TILE_COUNT };
