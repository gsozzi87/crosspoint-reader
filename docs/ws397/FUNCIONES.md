...
| 3.6 | Clima detallado (`WeatherActivity`, OK largo en el hub): ahora (temperatura, sensación, humedad, viento, salida y puesta del sol), próximas horas de a dos y seis días con barra de rango entre mínima y máxima y probabilidad de lluvia. `GET /api/hub/forecast` (Open-Meteo, caché de 15 min en el servidor y del último pronóstico en la SD, así abre sin WiFi); Atrás largo actualiza | ✅ | 1.5.30 (layout rehecho para los 480 px de ancho: ahora, ocho horas en dos filas y seis días con barra de rango). Falta la temperatura interior del SHTC3 (0.6) |
