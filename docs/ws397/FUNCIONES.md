...
| 1.8 | Pizarra de mensajes: página web del Hono (con el token) desde el teléfono: escribir mensajes, ver y editar recordatorios y listas, subir imágenes. Lo que es mensaje aparece en el hub y se marca leído con OK | ⬜ | Telegram descartado por ahora |
