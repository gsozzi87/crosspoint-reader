...
| 3.5 | Álbum de fotos (mosaico Fotos, `PhotosActivity`): se suben desde `/board` y el navegador del teléfono hace todo el trabajo (escala a 800x480, grises, difuminado Floyd-Steinberg y BMP de 2 bpp de 96 KB), el servidor solo guarda. El aparato lista, baja a `/Photos` de la SD y muestra a pantalla completa con refresco limpio; también lista los BMP que copies a mano. UP/DOWN pasan fotos, Atrás largo actualiza | ✅ | 1.5.28. Falta: salvapantallas de sueño con una foto |
